...
const footerLinks = {
  'Quick Links': ['Home', 'About Us', 'Services', 'Pricing', 'Portfolio', 'Contact'],
  'Services': ['Website Development', 'Mobile App Development', 'Digital Marketing', 'Brand Identity', 'SEO Services'],
  'Contact': ['hello@larawans.com', '+91 98765 43210', 'New Delhi, India'],
};
        ...
        <div className="border-t border-white/10 pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            {['Privacy Policy', 'Terms of Service', 'Sitemap'].map((link) => (
              <a key={link} href="#" className="text-[10px] sm:text-xs text-white/30 hover:text-white/60 transition-colors">
                {link}
              </a>
            ))}
          </div>
